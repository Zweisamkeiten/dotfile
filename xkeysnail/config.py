...
define_keymap(
    re.compile("Firefox|Google-chrome|firefoxdeveloperedition"),
    {
...
define_keymap(
    ...
    not in ("Emacs", "URxvt", "Alacritty", "scrcpy", "St", "jetbrains-idea-ce", "kitty"),
    {
        # Cursor
        ...
        # Cursor Vim-like
        # K("RSuper-h"): with_mark(K("h")),
        # K("RSuper-n"): with_mark(K("j")),
        # K("RSuper-e"): with_mark(K("k")),
        # K("RSuper-i"): with_mark(K("l")),
